...
export default function InfluencerPageComponent() {
    ...
    useEffect(() => {
        // Try getting influencer data from location state
        if (location.state?.influencer) {
            ...
            console.log("influencer data from location state : ", location.state.influencer)
        } else {
            // Otherwise, get from localStorage
            const storedData = localStorage.getItem("selectedInfluencer");
            if (storedData) {
                setInfluencer(JSON.parse(storedData));
                console.log("influencer data from location state : ", storedData)
            }
        }
